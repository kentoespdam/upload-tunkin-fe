...
export type InputTextZodProps<TData extends FieldValues> = CommonInputProps<TData> & {
  inputType: TextInputType;
};

export type InputFileZodProps<TData extends FieldValues> = CommonInputProps<TData> & {
  inputType: "file";
